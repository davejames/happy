...
export const SettingsSchema = z.object({
    ...
    voicePushToTalk: z.boolean().describe('Use push-to-talk instead of always-on mic for OpenAI/local voice'),
    localVoiceSttUrl: z.string().describe('Local voice STT endpoint (whisper.cpp whisper-server /inference)'),
    localVoiceTtsUrl: z.string().describe('Local voice TTS endpoint (piper HTTP wrapper: POST {input} -> WAV)'),
